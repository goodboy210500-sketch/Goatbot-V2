...
module.exports = {
	...
	langs: {
		        vi: {
            list: "== [ 𝐒𝐔𝐏𝐄𝐑 𝐒𝐓𝐔𝐃𝐈𝐎 ] ==\n📝 Danh sách thành viên bị cảnh cáo:\n%1\n━━━━━━━━━━━━━\n💡 Để xem chi tiết, dùng lệnh: warn list [UID]",
            listBan: "== [ 𝐒𝐔𝐏𝐄𝐑 𝐒𝐓𝐔𝐃𝐈𝐎 ] ==\n🚫 Danh sách thành viên bị trục xuất do nhận đủ 3 gậy:\n%1",
            listEmpty: "[ 𝐒𝐔𝐏𝐄𝐑 𝐒𝐓𝐔𝐃𝐈𝐎 ] ➜ Nhóm chưa có thành viên nào bị cảnh cáo.",
            listBanEmpty: "[ 𝐒𝐔𝐏𝐄𝐑 𝐒𝐓𝐔𝐃𝐈𝐎 ] ➜ Nhóm chưa có thành viên nào bị ban khỏi box.",
            invalidUid: "[ 𝐒𝐔𝐏𝐄𝐑 𝐒𝐓𝐔𝐃𝐈𝐎 ] ➜ UID người dùng không hợp lệ.",
            noData: "[ 𝐒𝐔𝐏𝐄𝐑 𝐒𝐓𝐔𝐃𝐈𝐎 ] ➜ Người dùng này chưa có dữ liệu vi phạm.",
            noPermission: "[ 𝐒𝐔𝐏𝐄𝐑 𝐒𝐓𝐔𝐃 I O ] ➜ Chỉ Quản trị viên nhóm mới có thể gỡ lệnh ban.",
            invalidUid2: "[ 𝐒𝐔𝐏𝐄𝐑 𝐒𝐓𝐔𝐃 I O ] ➜ Vui lòng nhập UID hợp lệ để gỡ ban.",
            notBanned: "[ 𝐒𝐔𝐏𝐄𝐑 𝐒𝐓𝐔𝐃 I O ] ➜ Người dùng này hiện không bị ban khỏi nhóm.",
            unbanSuccess: "[ 𝐒𝐔𝐏𝐄𝐑 𝐒𝐓𝐔𝐃 I O ] ➜ Đã gỡ lệnh ban thành công cho [%1 | %2].",
            noPermission2: "[ 𝐒𝐔𝐏𝐄𝐑 𝐒𝐓𝐔𝐃 I O ] ➜ Chỉ Quản trị viên mới có thể gỡ cảnh cáo.",
            invalidUid3: "[ 𝐒𝐔𝐏𝐄𝐑 𝐒𝐓𝐔𝐃 I O ] ➜ Vui lòng nhập UID hoặc tag người muốn gỡ gậy.",
            noData2: "[ 𝐒𝐔𝐏𝐄𝐑 𝐒𝐓𝐔𝐃 I O ] ➜ Thành viên này chưa có dữ liệu cảnh cáo.",
            notEnoughWarn: "[ 𝐒𝐔𝐏𝐄𝐑 𝐒𝐓𝐔𝐃 I O ] ➜ Người dùng này chỉ có %1 lần cảnh cáo.",
            unwarnSuccess: "[ 𝐒𝐔𝐏𝐄𝐑 𝐒𝐓𝐔𝐃 I O ] ➜ Đã xóa lần vi phạm thứ %1 của thành viên [%2 | %3].",
            noPermission3: "[ 𝐒𝐔𝐏𝐄𝐑 𝐒𝐓𝐔𝐃 I O ] ➜ Chỉ Quản trị viên mới có thể reset dữ liệu.",
            resetWarnSuccess: "[ 𝐒𝐔𝐏𝐄𝐑 𝐒𝐓𝐔𝐃 I O ] ➜ Đã xóa toàn bộ lịch sử vi phạm của nhóm thành công!",
            noPermission4: "[ 𝐒𝐔𝐏𝐄𝐑 𝐒𝐓𝐔𝐃 I O ] ➜ Chỉ Quản trị viên mới có quyền thực thi lệnh warn.",
            invalidUid4: "[ 𝐒𝐔𝐏𝐄𝐑 𝐒𝐓𝐔𝐃 I O ] ➜ Vui lòng tag hoặc reply tin nhắn để cảnh cáo.",
            warnSuccess: "== [ 𝐒𝐔𝐏𝐄𝐑 𝐒𝐓𝐔𝐃𝐈𝐎 ] ==\n⚠️ Đã thực thi cảnh cáo thành viên: %1\n📊 Lần vi phạm: %2/3\n📝 Lý do: %4\n📅 Ngày: %5\n━━━━━━━━━━━━━",
            noPermission5: "[ 𝐒𝐔𝐏𝐄𝐑 𝐒𝐓𝐔𝐃 I O ] ➜ Vui lòng thêm Bot làm QTV để thực thi lệnh Kick!",
            warnSuccess2: "== [ 𝐒𝐔𝐏𝐄𝐑 𝐒𝐓𝐔𝐃𝐈𝐎 ] ==\n⚠️ Cảnh cáo lần %2 đối với %1\n📝 Lý do: %4\n🚫 Nếu nhận đủ 3 gậy sẽ bị trục xuất!",
            hasBanned: "== [ 𝐒𝐔𝐏𝐄𝐑 𝐒𝐓𝐔𝐃𝐈𝐎 ] ==\n🚫 Thành viên %1 đã nhận đủ 3 gậy vi phạm.\n➜ Hệ thống tự động trục xuất khỏi nhóm!",
            failedKick: "[ 𝐒𝐔𝐏𝐄𝐑 𝐒𝐓𝐔𝐃 I O ] ➜ Gặp lỗi khi cố gắng kick các thành viên: %1",
            userNotInGroup: "[ 𝐒𝐔𝐏𝐄𝐑 𝐒𝐓𝐔𝐃 I O ] ➜ Người dùng [%1] hiện không có trong nhóm."
        },
